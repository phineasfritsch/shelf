...
[Quick start](#quick-start) · [How it works](#how-it-works) · [Remote access](#access-it-from-anywhere) · [Configuration](docs/configuration.md) · [Security](docs/security.md)

</div>

<div align="center">
<img src="docs/media/shelf-desktop.jpg" alt="Shelf open on a laptop: a shared text box with notes, a link chip, and two file cards" width="720">
</div>
...
- **Phone-first.** Installable PWA, home-screen icon, Android share-sheet target, iOS-safe copy and paste, big touch
  targets, keyboard-aware layout, dark mode.
